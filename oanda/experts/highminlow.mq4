...
extern string CustomComment = "Strategy 0.10433";
...
int start() {
   ...
   bool LongEntryCondition = (((iStochastic(NULL, 0, pMT4_STOCH_SIGNAL_1, pMT4_STOCH_SIGNAL_2, pMT4_STOCH_SIGNAL_3, MODE_SMA, 0, MODE_SIGNAL, 2) < iStochastic(NULL, 0, pMT4_STOCH_4, pMT4_STOCH_5, pMT4_STOCH_6, MODE_SMA, 0, MODE_MAIN, 2)) && (iStochastic(NULL, 0, pMT4_STOCH_SIGNAL_1, pMT4_STOCH_SIGNAL_2, pMT4_STOCH_SIGNAL_3, MODE_SMA, 0, MODE_SIGNAL, 1) > iStochastic(NULL, 0, pMT4_STOCH_4, pMT4_STOCH_5, pMT4_STOCH_6, MODE_SMA, 0, MODE_MAIN, 1))) && ((High[16] < Low[14]) || (Open[6] > High[11])));
   if(TradeLong && getMarketPosition() == 0 && LongEntryCondition == true) {
      openPosition(1);
   }
   
   // SHORT: ((StochSignal(21, 3, 3) Crosses Below Stoch(5, 3, 3)) And ((Low(16) > High(14)) Or (Open(6) < Low(11))))
   bool ShortEntryCondition = (((iStochastic(NULL, 0, pMT4_STOCH_SIGNAL_7, pMT4_STOCH_SIGNAL_8, pMT4_STOCH_SIGNAL_9, MODE_SMA, 0, MODE_SIGNAL, 2) > iStochastic(NULL, 0, pMT4_STOCH_10, pMT4_STOCH_11, pMT4_STOCH_12, MODE_SMA, 0, MODE_MAIN, 2)) && (iStochastic(NULL, 0, pMT4_STOCH_SIGNAL_7, pMT4_STOCH_SIGNAL_8, pMT4_STOCH_SIGNAL_9, MODE_SMA, 0, MODE_SIGNAL, 1) < iStochastic(NULL, 0, pMT4_STOCH_10, pMT4_STOCH_11, pMT4_STOCH_12, MODE_SMA, 0, MODE_MAIN, 1))) && ((Low[16] > High[14]) || (Open[6] < Low[11])));
   if(TradeShort && getMarketPosition() == 0 && ShortEntryCondition == true) {
      openPosition(-1);
   }
...
double HeikenAshiOpen(int period) {    
   return(iCustom( NULL, 0, "Heiken Ashi", 0,0,0,0, 2, period));
}

double HeikenAshiClose(int period) {    
   return(iCustom( NULL, 0, "Heiken Ashi", 0,0,0,0, 3, period));
}

double HeikenAshiHigh(int period) {    
   return(MathMax(iCustom( NULL, 0, "Heiken Ashi", 0,0,0,0, 0, period), iCustom( NULL, 0, "Heiken Ashi", 0,0,0,0, 1, period)));
}

double HeikenAshiLow(int period) {    
   return(MathMin(iCustom( NULL, 0, "Heiken Ashi", 0,0,0,0, 0, period), iCustom( NULL, 0, "Heiken Ashi", 0,0,0,0, 1, period)));
}
