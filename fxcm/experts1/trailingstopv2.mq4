...
extern int InitialTrailingStop = 350;
...
int init()
  {
//----
infobox = StringConcatenate("Account #",AccountNumber(), " leverage is ", AccountLeverage(), ", TrailingStop #",TrailingStop);
//----
   return(0);
  }
//+------------------------------------------------------------------+
      ...
      if(OrderType()<=OP_SELL  // check for opened position
         ...
         infobox = StringConcatenate(infobox, "\n", Symbol(), ", Ordder Profit: ", OrderProfit(), ", OrderOpenPrice: ", OrderOpenPrice());
            if(OrderType()==OP_BUY) {
               ...
               {                 
                  infobox = StringConcatenate(infobox, Symbol(), "\n", ", Bid-OrderOpenPrice(): ", (Bid-OrderOpenPrice()), ", Point*InitialTrailingStop: ", (Point*InitialTrailingStop));
