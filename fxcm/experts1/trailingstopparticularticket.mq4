   ...
   for(cnt=0;cnt<total;cnt++)
     {
      ...
      && OrderTicket() == orderticket
         ...
         infobox = StringConcatenate(infobox, "\n", OrderSymbol(), ", Bid: ", bids, ", Ask: ", asks, ", orderticket: ", orderticket, ", OrderTicket(): ", OrderTicket());
         infobox = StringConcatenate(infobox, "\n", OrderSymbol(), ", Order Profit: ", OrderProfit(), ", OrderOpenPrice: ", OrderOpenPrice());
            if(OrderType()==OP_BUY) {
