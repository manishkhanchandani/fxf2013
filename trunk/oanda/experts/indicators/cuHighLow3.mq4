...
//---- last counted bar will be recounted
   ...
   int condition = 0;
     ...
     /* double initialAmount = AccountBalance();
      ...
      infobox = infobox + "Strategy " + strategy + ", strategyText: " +get_strategy_name(strategy)+ "\n";
         double close1;
         int time1;
         int check = 0;
         double close2;
      ...
      int check2 = get_strategy_result(strategy, Symbol(), Period(), j, 1);
      infobox = infobox + "\nFpips Earned: " + fpips + ", Strategy Type: " + check2;
