...
//****************************************************************************//
// Функция nfUp возвращает ближайшее слева к переданной свече значение буфера //
// индикатора, большее или равное значению High(Close) для переданной свечи   //
//****************************************************************************//
double nfUp(int i)
   {
   int l,flag=0;
...
//****************************************************************************//
// Функция nfDn возвращает ближайшее слева к переданной свече значение буфера //
// индикатора, меньшее или равное значению Low(Close) для переданной свечи    //
//****************************************************************************//
double nfDn(int i)
   {
   int l,flag=0;
...
//*****************************************************************************************//
// Функция возвращает для переданной ей свечи, минимальное количество свечей слева         //
// включая "внутренние", для того, чтобы число не внутренних свечей в полученном диапазоне //
// было не меньше, чем указано во втором параметре                                         //
//*****************************************************************************************//
...
//*****************************************************************************************//
// Функция возвращает для переданной ей свечи, минимальное количество свечей справа        //
// включая "внутренние", для того, чтобы число не внутренних свечей в полученном диапазоне //
// было не меньше, чем указано во втором параметре                                         //
//*****************************************************************************************//
