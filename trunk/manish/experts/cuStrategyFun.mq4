...
double todaysPlan;
extern double fixedLots = 0.06;
extern bool currentSymbol = true;
extern int strategy = 23;
extern int speriod = 0;
...
//----
   ...
   //trailingstop(magic);
      for (x = 0; x < ARRSIZE; x++) {
         ...
         /*if (x == EURJPY) {speriod = PERIOD_M1; strategy = 1;}
         else if (x == XAUJPY) {speriod = PERIOD_H1; strategy = 7;}
         else if (x == XAGJPY) {speriod = PERIOD_H1; strategy = 10;}
         else if (x == XAUUSD) {speriod = PERIOD_M30; strategy = 22;}
         else if (x == XAGUSD) {speriod = PERIOD_D1; strategy = 7;}
         else if (x == EURAUD) {speriod = PERIOD_H4; strategy = 10;}
         else if (x == GBPJPY) {speriod = PERIOD_H1; strategy = 22;}
         else if (x == AUDJPY) {speriod = PERIOD_H1; strategy = 3;}
         else if (x == CHFJPY) {speriod = PERIOD_M30; strategy = 17;}
         else if (x == NZDJPY) {speriod = PERIOD_H1; strategy = 22;}
         else {speriod = PERIOD_M1; strategy = 23;}*/
         ///speriod = Period(); strategy = 23;
         if (x == AUDJPY) {speriod = PERIOD_M30; strategy = 10;}
         else if (x == EURAUD) {speriod = PERIOD_M15; strategy = 25;}
         else if (x == USDJPY) {speriod = PERIOD_M15; strategy = 21;}
         else continue;
