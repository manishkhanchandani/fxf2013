...
extern double max_loss_per_day = -30;

extern bool current_symbol = false;
extern bool ignore_particular_currency = false;
extern string ignore_currency = ""; //e.g. GB
extern bool ignore_particular_symbol = true;
extern string ignore_symbol = "AUDNZD"; //e.g. USDJPY
extern bool only_particular_currency = true;
extern string only_currency = "AUD"; //e.g. GB
...
int strategy()
{
   ...
   //if (openTime != Time[0]) {
      string mySymbol;
      infobox = "";
      filename = "heikenmod2/" + Year() + "_" + Month() + "_" + Day()  + ".txt";
      //FileDelete(filename);
      impbox = "\n";
      createbox = "\n";
      trailing_stop();
