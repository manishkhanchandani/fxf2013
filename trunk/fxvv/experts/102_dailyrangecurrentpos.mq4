...
int custom_start(int num, int cur_num)
{
   ...
   double currentopen1, currentopen2, currentbuy, currentsell, currentbuytp, currentbuysl, currentselltp, currentsellsl;
   currentopen1 = Bid;
   currentopen2 = Ask;
   currentbuy = currentopen2 + twentyfivepercent;
   currentsell = currentopen1 - twentyfivepercent;
   //currentbuytp = currentbuy + twentyfivepercent;
   currentbuytp = currentopen2 + twentyfivepercent + twentyfivepercent;
   currentbuysl = currentopen2 - stop;
   //currentbuysl = currentsell;
   //currentselltp = currentsell - twentyfivepercent;
   currentselltp = currentopen1 - (twentyfivepercent + twentyfivepercent);
   currentsellsl = currentopen1 + stop;
   ...
   "\nCurrent Open Price1: ", DoubleToStr(currentopen1, Digits),
   "\nCurrent Open Price2: ", DoubleToStr(currentopen2, Digits),
