...
//---- indicators
   ...
   ObjectDelete("Support Middle 1");
   ObjectDelete("Support 2");
   ObjectDelete("Support Middle 2");
   ObjectDelete("Support 3");
   ObjectDelete("Piviot level");
   ObjectDelete("Resistance 1");
   ObjectDelete("Resistance Middle 1");
   ObjectDelete("Resistance 2");
   ObjectDelete("Resistance Middle 2");
...
drawLine(rm1,"RM1", DarkGreen,3);
drawLabel("Resistance Middle 1",rm1,DarkGreen);
drawLine(rm2,"RM2", Green,3);
drawLabel("Resistance Middle 2",rm2,Green);
...
drawLine(sm1,"SM1",Maroon,3);
drawLabel("Support Middle 1",sm1,Maroon);
drawLine(sm2,"SM2",Crimson,3);
drawLabel("Support Middle 2",sm2,Crimson);
