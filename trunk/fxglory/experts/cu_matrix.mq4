...
for (i=1;i<=30;i++) //Loop of values displaying

//Forming unique object names
{
   infobox = StringConcatenate(infobox, "f", i, ": ", f[i], ", ", fs[i], "\n");
   /*
   ...
   ObjectSetText(ident,info,6,"Arial", Black);*/
} //describing displaying format and displaying
  Comment(infobox);
